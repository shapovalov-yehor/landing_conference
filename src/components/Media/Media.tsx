        ...
        <div className={styles.main_wrap}>
          <ul className={styles.list}>
            <li className={styles.item}>
              ...
              <p>
                <span>Наш YouTube-канал</span> вырос из простых обучающих видео
                в полноценную медиа-платформу с аудиторией более 18,000
                подписчиков. Мы говорим о сложных вещах простым языком и делимся
                реальным опытом.
              </p>
            </li>
            <li className={styles.item}>
              ...
              <p>
                ...
                отличным инструментом для поддержания активности аудитории.
                Общая численность подписчиков наших Telegram-ботов насчитывает (
                актуальное число на время ВЕРСТКИ ) пользователей.
              </p>
            </li>
            <li className={styles.item}>
              <div className={styles.icon_wrap}>
              ...
              <div className={styles.bot_wrap}>
                ...
                <ul className={styles.bot_list}>
                  <li>
                    <p>
                      Бот для уникализации креативов упростил работу с
                      визуальным контентом
                    </p>
                  </li>
                  <li>
                    <p>
                      Гивэвей-боты создают дополнительную ценность для
                      сообщества;
                    </p>
                  </li>
                  <li>
