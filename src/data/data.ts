...
export const contactsTexts = [
  {
    text: 'Саппорт по креативам -',
    name: '@mustage_creo',
    link: 'mustage_creo',
  },
  {
    text: 'Саппорт по аккаунтам -',
    name: '@mustage_support',
    link: 'mustage_support',
  },
  {
    text: 'Саппорт по прокси -',
    name: '@mustage_proxy',
    link: 'mustage_proxy',
  },
  {
    text: 'Куратор на бесплатном курсе по арбитражу трафика -',
    name: '@mustage_study',
    link: 'mustage_study',
  },
];
...
export const resourseItems = [
  ...
  {
    text: 'Заказать креативы для арбитража (разные вертикали)',
    icon: 'icon-creativity-order',
    link: 'https://mustage.io/creo',
  },
  {
    text: 'Портфолио с креативами',
    icon: 'icon-portfolio',
